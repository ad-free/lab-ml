...
class DataScience:
    def __init__(self, url: str = None, width: int = 12, height: int = 10):
        self.width = width
        self.height = height
        self.url = "https://s3-api.us-geo.objectstorage.softlayer.net/cf-courses-data/CognitiveClass/DA0101EN/automobileEDA.csv"
        Download(url=self.url, filename='automobileEDA.csv')
        self.df = pd.read_csv('download/automobileEDA.csv')
